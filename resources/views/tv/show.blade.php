...
<div class="movie-info border-b border-grey-800">
	<div class="container mx-auto px-8 py-16 flex flex-col md:flex-row">
		...
		<div class="md:ml-24">
			<h2 class="lg:text-4xl font-semibold">{{$movie['name']}}</h2>
			<div class="mt-2">
...
<div class="mt-4">
			<div>Number of seasons:{{$movie['number_of_seasons']}}</div>
			<div class="text-grey-400 text-sm">Number of episodes:{{$movie['number_of_episodes']}}</div>
		</div>
